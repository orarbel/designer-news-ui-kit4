Pod::Spec.new do |spec|
  spec.name          = 'DesignerNewsUIKit'
  spec.version       = '1.0'
  spec.license       = { :type => 'MIT' }
  spec.homepage      = 'http://www.animaapp.com'
  spec.authors       = { 'orarbel@gmail.com' => '' }
  spec.summary       = 'DesignerNews UI Kit'
  spec.source        = { :git => '' }
  spec.source_files  = 'DesignerNewsUIKit/*.{h,m,swift}'
  ...
  spec.resources     = ['DesignerNewsUIKit/**/*.{xcassets,storyboard}', 'DesignerNewsUIKit/Resources/**/*.*']
